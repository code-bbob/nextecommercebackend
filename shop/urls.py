...
urlpatterns = [
    ...
    path('api/visits/', views.VisitView.as_view(), name='visits'),
    path('api/auction/', views.AuctionProductView.as_view(), name='auction'),
    ...
    path('api/catsearch/<str:name>/<str:brandname>/<str:series>/', views.CatSearch.as_view(), name='catsearch'),
